...
const char* ssid = "Getbox-NERSETH";
const char* password = "123entotre456";
...
void loop()
{
  ...
  client.println("</style>");  
  client.println("Pattern is now: ");
  client.println(gCurrentPatternNumber);
  client.println("<br><br>");
  client.println("<a href=\"/nextpattern\"\"><button>Next Pattern</button></a>");
  client.println("</html>");
  delay(10);
